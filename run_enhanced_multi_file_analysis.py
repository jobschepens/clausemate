...
from multi_file.enhanced_output_system import EnhancedOutputSystem, ChapterMetadata, CrossChapterConnection
...
def main():
    ...
    try:
        ...
        logger.info(f"Multi-file processing complete: {len(result.unified_relationships)} relationships")
        ...
        cross_chapter_connections = convert_cross_chapter_chains_to_connections(result.cross_chapter_chains)
        
        logger.info(f"Converted {len(chapter_metadata)} chapter metadata objects")
        logger.info(f"Converted {len(cross_chapter_connections)} cross-chapter connections")
        ...
        logger.info(f"Character tracking complete: {len(character_profiles)} characters identified")
        ...
        logger.info(f"Narrative flow analysis complete: {len(narrative_segments)} segments identified")
        ...
        logger.info(f"Cross-chapter transition analysis complete: {len(transitions)} transitions analyzed")
        ...
        logger.info(f"Performance metrics calculated: {performance_metrics.relationships_per_second:.2f} rel/sec")
        ...
        logger.info(f"Performance: {performance_metrics.relationships_per_second:.2f} relationships/second")
