...
def test_visualization():
    ...
    chains_file = Path("data/output/unified_analysis_20250729_123353/cross_chapter_chains.json")
    stats_file = Path("data/output/unified_analysis_20250729_123353/processing_statistics.json")
