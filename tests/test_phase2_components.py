...
class TestDataModels(unittest.TestCase):
    ...
    def test_sentence_context_creation(self):
        ...
        tokens = [
            Token(idx=1, text="Er", sentence_num=1, grammatical_role="SUBJ", thematic_role="AGENT"),
            Token(idx=2, text="sieht", sentence_num=1, grammatical_role="PRED", thematic_role="ACTION")
        ]
